...
contract Exchange is ERC20 {
    ...
    address public mysteryTokenAddress;

    // Exchange is inheriting ERC20, becase our exchange would keep track of Crypto Dev LP tokens
    constructor(address _Mysterytoken) ERC20("CryptoDev LP Token", "CDLP") {
        require(_Mysterytoken != address(0), "Token address passed is a null address");
        mysteryTokenAddress = _Mysterytoken;
    }
...
*/
    function getReserve() public view returns (uint) {
        return ERC20(mysteryTokenAddress).balanceOf(address(this));
    }
...
*/
    function addLiquidity(uint _amount) public payable returns (uint) {
        ...
        ERC20 cryptoDevToken = ERC20(mysteryTokenAddress);
    /*
...
*/
    ...
    // Transfer `cryptoDevTokenAmount` of `Crypto Dev` tokens from the user's wallet to the contract
        ERC20(mysteryTokenAddress).transfer(msg.sender, cryptoDevTokenAmount);
    ...
    */
    ...
    ERC20(mysteryTokenAddress).transfer(msg.sender, tokensBought);
    }
    ...
    */
    ...
    uint256 tokenReserve = getReserve();
        ...
        ERC20(mysteryTokenAddress).transferFrom(
            msg.sender,
            address(this),
            _tokensSold
        );
